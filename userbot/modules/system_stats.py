...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Diyo userbot](https://github.com/masjarwo123/Diyo) is Up and Running.**\n\n"
        f"**{alive_text}**\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/kalongclub)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/chipmunkchanel)** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={user.id})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
